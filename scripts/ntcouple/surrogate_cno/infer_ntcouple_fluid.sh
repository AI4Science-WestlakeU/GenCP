#!/bin/bash
# Inference script for NTcouple fluid/coolant field with surrogate model
...
CHECKPOINT_PATH=/path/to/results/ntcouple/fluid_CNO_surrogate/checkpoint/best_main_model.pth
