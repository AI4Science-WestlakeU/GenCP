#!/bin/bash
# Inference script for NTcouple fluid/coolant field with GenCP framework (SiT_FNO backbone)
...
CHECKPOINT_PATH="/path/to/results/ntcouple/fluid_SiT_FNO/ckpt/best_main_model.pth"
