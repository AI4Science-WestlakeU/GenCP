...
import torch
import math
from models.CNO_libs.training.filtered_networks import LReLu #Either "filtered LReLU" or regular LReLu
#------------------------------------------------------------------------------
...
class CNO3d(nn.Module):
    ...
    def forward(self, x, t, cond=None, self_cond=None):
        # Compute time embeddings for FiLM conditioning
        ...
        if self.add_inv:
            x = self.decoder_inv[self.N_layers](x, time_emb)
