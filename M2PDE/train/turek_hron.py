...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_id", default="turek_hron", type=str, help="experiment folder id")
    ...
    cache_dir_name = generate_cache_dir_name(args, "turek_hron")
    ...
    if args.use_cache:
        ...
        if not check_cache_exists(cache_dir_name, 'train') or args.force_recreate_cache:
            ...
            temp_train_dataset = TurekHronDataset(dataset_path=ABSOLUTE_PATH,
                                             length=args.length,
        ...
        #     temp_val_dataset = TurekHronDataset(dataset_path=ABSOLUTE_PATH,
        #                                      length=args.length,
        #                                      input_size=args.input_step,
        #                                      output_size=args.output_step,
        #                                      stride=args.stride,
    ...
    train_dataset = TurekHronDataset(dataset_path=ABSOLUTE_PATH,
                                     length=args.length,
                                     input_size=args.input_step,
                                     output_size=args.output_step,
                                     stride=args.stride,
    ...
    val_dataset_original = TurekHronDataset(dataset_path=ABSOLUTE_PATH,
                                     length=args.length,
                                     input_size=args.input_step,
                                     output_size=args.output_step,
                                     stride=args.stride,
