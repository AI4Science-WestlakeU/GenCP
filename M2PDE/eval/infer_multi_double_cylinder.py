...
def main(args):
    ...
    fluid_trainset = DoubleCylinderDataset(dataset_path=ABSOLUTE_PATH, length=args.length, input_size=args.input_step, output_size=args.output_step, stride=args.stride, mode='train', num_delta_t=args.num_delta_t,
                                            stage='fluid', dt=args.dt)
    structure_trainset = DoubleCylinderDataset(dataset_path=ABSOLUTE_PATH, length=args.length, input_size=args.input_step, output_size=args.output_step, stride=args.stride, mode='train', num_delta_t=args.num_delta_t,
                                            stage='structure', dt=args.dt)
    couple_trainset = DoubleCylinderDataset(dataset_path=ABSOLUTE_PATH, length=args.length, input_size=args.input_step, output_size=args.output_step, stride=args.stride, mode='train', num_delta_t=args.num_delta_t,
    ...
    val_dataset = DoubleCylinderDataset(dataset_path=ABSOLUTE_PATH, length=args.length, input_size=args.input_step, output_size=args.output_step, stride=args.stride, mode='val', num_delta_t=args.num_delta_t,
                                            stage='couple', dt=args.dt)
