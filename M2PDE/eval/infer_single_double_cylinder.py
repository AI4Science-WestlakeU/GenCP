...
def main(args):
    ...
    # Load datasets
    train_dataset = DoubleCylinderDataset(dataset_path=ABSOLUTE_PATH, length=args.length, input_size=args.input_step, output_size=args.output_step, stride=args.stride, mode='train', num_delta_t=args.num_delta_t
