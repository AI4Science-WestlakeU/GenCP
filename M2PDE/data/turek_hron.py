...
class TurekHronDataset(Dataset):
    """
    FluidZero dataset class
    Inherits from BaseFluidDataset, specialized for fluidzero_data format
    """
    ...
    def __init__(self, dataset_path, length=50, input_size=1, output_size=1, stride=10, mode='train', stage='fluid', num_delta_t=1, dt=1, use_cache=True, cache_dir_name=None):
        ...
        if use_cache:
            ...
            if cache_dir_name is None:
                ...
                cache_dir_name = generate_cache_dir_name(dummy_args, "turek_hron")
        ...
        if stage == 'fluid':
            ...
            file_path = 'turek_hron/beam_condition_on_flow/' # couple
